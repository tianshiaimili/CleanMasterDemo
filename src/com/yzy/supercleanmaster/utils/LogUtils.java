...
//						message);
				...
				Log.e(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"行 ]:"+
						message);
			}
		}
	}
...
//						message);
				...
				Log.d(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"行 ]:"+
						message);
			}
		}
	}
...
//						message);
				Log.i(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"行 ]:"+
						message);
			}
		}
	}
...
//						message);
				Log.w(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"行 ]:"+
						message);
			}
		}
	}
	...
	public static void v(String message) {
		if (DEBUG_V) {
			...
			if (elements.length < 3) {
				...
				Log.v(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"行 ]:"+
						message);
